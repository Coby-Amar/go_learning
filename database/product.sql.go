...
VALUES ($1,$2,$3,$4,$5)
RETURNING _id, _created_at, _updated_at, _name, _amount, _carbohydrate, _protein, _fat
`
...
SELECT _id, _created_at, _updated_at, _name, _amount, _carbohydrate, _protein, _fat FROM _products
`
